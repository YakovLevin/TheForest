...
public class Content {
	...
	public static BufferedImage[][] HELPBG = load("/HUD/helpscreen.gif", 128, 144);
	public static BufferedImage[][] TOPBG = load("/HUD/topscreen.gif", 128, 144);
	public static BufferedImage[][] STOPBG = load("/HUD/stopScreen.gif", 98, 112);
	public static BufferedImage[][] WONBG = load("/HUD/wonscreen.gif", 128, 144);
	public static BufferedImage[][] LOSTBG = load("/HUD/lostscreen.gif", 128, 144);
